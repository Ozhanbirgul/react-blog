  ...
  return (
    <div>
      <div>
        ...
        <div>
            {
                popularBlogs.slice(0,5).map(blog => <div key={blog?.id} className='my-5 border-b-2 border-spacing-2 px-4'>
                    ...
                    <Link to="/" className='text-base pb-2 font-semibold hover:text-orange-500 inline-flex items-center py-1'>
        ...
        <div>
            {
                popularBlogs.slice(5,11)?.map(blog => <div key={blog?.id} className='my-5 border-b-2 border-spacing-2 px-4'>
                    <h4 className='font-medium mb-2'>{blog?.title}</h4>
                    <Link to="/" className='text-base pb-2 font-semibold hover:text-orange-500 inline-flex items-center py-1'>
                        Read More <FaArrowRight className='mt-1 ml-2' />
                    </Link>
